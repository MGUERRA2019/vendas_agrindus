            ...
            Row(
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    'Olá',
                    style: kHeaderText.copyWith(color: kLogoColor, fontSize: 40),
                  ),
                ),
                Container(
                      ...
                      try {
                        ...
                        if (e is FirebaseAuthException) {
                          if (e.code == 'user-not-found') {
                            ...
                            message = 'Houve uma falha de conexão da internet.';
                          }
                        }
                        Alert(
                          context: context,
                ...
                child: TextButton(
                  ...
                  child: IntrinsicHeight(
                    child: Row(
                      ...
                      children: [
                        Text('Cadastre-se', style: TextStyle(color: Colors.white, fontSize: 15)),
                        VerticalDivider(color: Colors.white, thickness: .75, indent: .5, endIndent: .5),
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text(
            label ?? '',
            style: TextStyle(fontSize: 15, color: Color(0xff8f9db5)),
          ),
        ),
        Padding(
